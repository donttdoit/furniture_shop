...
<body>
    ...
    <div class="product">
        <form action="scripts/product.php" method="post">
            <label>Цена: </label>
    ...
    <div class="car">
        <form action="scripts/car.php" method="post">
    ...
    <div class="client">
        <form action="scripts/client.php" method="post">
            <label>Имя: </label>
            <input type="text" name="name">
    ...
    <div class="storehouse">
        <form action="scripts/storehouse.php" method="post">
